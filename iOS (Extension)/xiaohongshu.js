...
//        const t = i.querySelector('.video-card__content');
        ...
        // 添加屏蔽的功能
        // 用来放关闭按钮的容器
        const h = i.querySelector('.cover');
        // up主的名字..
        const upDom = i.querySelector('.author .name');
        const titleDom = i.querySelector('.title span');
...
//        const t = i.querySelector('.video-card__content');
        ...
        const h = i.querySelector('.cover');
        // up主的名字..
        const channelNameDom = i.querySelector('.author .name');
